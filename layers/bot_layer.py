"""
Данный модуль отвечает за работу discord-бота, который принимает слеш-команды в чате для формирования на их основе
графиков из данных, полученных в базе данных(из модуля db_layer)
Модуль visualization_layer обеспечивает формирование графиков и является подчиненным этого модуля
Регистрационные данные бота лежат в файле .env
"""
